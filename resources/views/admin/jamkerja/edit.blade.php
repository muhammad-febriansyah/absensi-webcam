                        ...
                        <div class="card-body table-responsive">
                            <form id="form">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control time" value="{{ $data->in }}"
                                        name="in" placeholder="Jabatan" id="formrow-firstname-input">
                                </div>
                                <div class="mb-3">
                                    <label for="formrow-firstname-input" class="form-label">Jam Keluar</label>
                                    <input type="text" class="form-control time" value="{{ $data->out }}"
                                        name="out" placeholder="Jabatan" id="formrow-firstname-input">
                                </div>
                                <div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#form').on('submit', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('main.updatejamkerja', $data->id) }}',
                    data: $(this).serialize(),
                    beforeSend: function() {
                        Swal.fire({
