...
@section('content')
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="lokasi_penempatan_id" id="" class="form-control">
                                                @foreach ($locations as $location)
                                                    @if ($data->lokasi_penempatan_id == $location->id)
    ...
    <script>
        $(document).ready(function() {
            ...
            drawCircle(document.getElementById('lat').value, document.getElementById('long').value, document
            ...
            $('#form').on('submit', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('main.updateradius',$data->id) }}',
                    data: $(this).serialize(),
                    beforeSend: function() {
                        Swal.fire({
